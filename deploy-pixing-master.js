...
async function main() {
  ...
  const c = await client.request('CreateCommand', { RegionId: process.env.ALI_REGION || 'cn-guangzhou', Name: 'deploy-pixing2', Type: 'RunShellScript', CommandContent: b64, ContentEncoding: 'Base64', Timeout: '300' });
