...
export class ReportSessionStatusDto {
  ...
  @ApiProperty({ description: '伴侣实测登录态', enum: ['online', 'offline', 'blocked'] })
  @IsString()
  status!: 'online' | 'offline' | 'blocked'

  @ApiPropertyOptional({ description: '检测来源，如 collection / keepalive / scan' })
  @IsOptional()
  @IsString()
  source?: string
...
export class ReportPostStatItem {
  @ApiPropertyOptional({ description: '平台视频/帖子ID' })
  @IsOptional()
  @IsString()
  id?: string
  ...
  @ApiPropertyOptional({ description: 'Platform video/post ID' })
  @IsOptional()
  @IsString()
  contentId?: string
