...
export class AuthController {
  ...
  @ApiOperation({ summary: '获取飞书登录授权地址' })
  async getFeishuUrl(@Query('redirect') redirect?: string) {
    return this.authService.getFeishuAuthUrl(redirect)
  }
  ...
  async feishuCallback(@Body() dto: { code: string; state: string }) {
    return this.authService.loginWithFeishu(dto.code, dto.state)
  }
