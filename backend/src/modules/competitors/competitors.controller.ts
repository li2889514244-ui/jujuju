...
export class CompetitorsController {
  ...
  async findAll(
    ...
    return this.competitorsService.findAll(userId, {
      platform,
      skip: skip ? parseInteger(skip, 0, { min: 0 }) : undefined,
      take: take ? parseInteger(take, 50, { min: 1 }) : undefined,
    })
  }
  ...
  async compare(
    ...
    return this.competitorsService.compare(userId, competitorIds, parseInteger(days, 7, { min: 1 }))
  }
