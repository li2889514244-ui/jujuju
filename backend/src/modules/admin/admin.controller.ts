...
export class AdminController {
  ...
  async listOrganizations(
    ...
    return this.adminService.listOrganizations({
      skip: parseInteger(skip, 0, { min: 0 }),
      take: parseInteger(take, 20, { min: 1 }),
      search,
    })
  }
  ...
  @Get('system/enterprise-login')
  @ApiOperation({ summary: '企业登录配置诊断' })
  async getEnterpriseLoginSettings() {
    return this.adminService.getEnterpriseLoginSettings()
  }
}
