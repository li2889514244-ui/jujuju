...
function positiveInteger(value: unknown, fallback: number): number {
  return parseInteger(value, fallback, { min: 1 })
}

function cappedPositiveInteger(value: unknown, fallback: number, max: number): number {
  return Math.min(max, positiveInteger(value, fallback))
}

function optionalPositiveInteger(value: unknown): number | undefined {
  if (value === undefined || value === null || String(value).trim() === '') return undefined
  const parsed = parseInteger(value, Number.NaN, { min: 1 })
...
export class AnalyticsController {
  ...
  async getFollowerTrend(
    ...
    return this.analyticsService.getFollowersTrend(userId, positiveInteger(days, 7), platform, groupId)
  }
  ...
  async getViewsTrend(
    ...
    return this.analyticsService.getViewsTrend(userId, positiveInteger(days, 7), platform, groupId)
  }
  ...
  async getOverview(
    ...
    return this.analyticsService.getOverview(userId, groupId, platform)
  }
  ...
  async getPlatformComparison(
    ...
    return this.analyticsService.getPlatformComparison(userId, groupId, platform)
  }
  ...
  async getComparison(
    ...
    return this.analyticsService.getComparison(userId, groupId, platform)
  }
  ...
  async getViewsRanking(
    ...
    return this.analyticsService.getViewsRanking(userId, {
      limit: cappedPositiveInteger(limit, 50, 100),
      period: period || 'all',
      platform,
      groupId,
    })
  ...
  async getLikesTrend(
    ...
    return this.analyticsService.getLikesTrend(userId, positiveInteger(days, 7), platform)
  }
  ...
  async getPublishEffect(
    ...
    return this.analyticsService.getPublishEffect(userId, optionalPositiveInteger(days), contentId, groupId)
  }
  ...
  async getEngagementRate(
    ...
    return this.analyticsService.getEngagementRate(userId, positiveInteger(days, 7), platform, groupId)
  }
  ...
  async getMonetization(
    ...
    return this.analyticsService.getMonetization(userId, positiveInteger(days, 30), platform)
  }
  ...
  async getAccountPosts(
    ...
    return this.analyticsService.getAccountPosts(accountId, {
      ...
      pageSize: positiveInteger(pageSize, 20),
