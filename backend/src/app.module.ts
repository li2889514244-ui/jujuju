...
import { readIntegerEnv } from './config/env-number'
...
@Module({
  imports: [
    ...
    ThrottlerModule.forRoot([
      {
        name: 'short',
        ttl: readIntegerEnv('THROTTLE_SHORT_TTL_MS', 1000, { min: 1 }),
        limit: readIntegerEnv('THROTTLE_SHORT_LIMIT', 100, { min: 1 }),
      },
      {
        name: 'medium',
        ttl: readIntegerEnv('THROTTLE_MEDIUM_TTL_MS', 10000, { min: 1 }),
        limit: readIntegerEnv('THROTTLE_MEDIUM_LIMIT', 500, { min: 1 }),
      },
      {
        name: 'long',
        ttl: readIntegerEnv('THROTTLE_LONG_TTL_MS', 60000, { min: 1 }),
        limit: readIntegerEnv('THROTTLE_LONG_LIMIT', 3000, { min: 1 }),
      },
    ]),
    RedisModule,
    PrismaModule,
