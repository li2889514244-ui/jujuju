...
var KuaishouCollector_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.KuaishouCollector = void 0;
...
let KuaishouCollector = KuaishouCollector_1 = class KuaishouCollector {
    constructor(prisma, oauthService) {
        this.prisma = prisma;
        this.oauthService = oauthService;
        this.platform = 'KUAISHOU';
        this.logger = new common_1.Logger(KuaishouCollector_1.name);
    }
    ...
    async collectDailyMetrics(accountId) {
        try {
            ...
            await this.prisma.dailyStats.create({
                data: {
                    accountId, date: new Date(), platform: 'KUAISHOU',
...
exports.KuaishouCollector = KuaishouCollector;
exports.KuaishouCollector = KuaishouCollector = KuaishouCollector_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService,
        oauth_service_1.OAuthService])
], KuaishouCollector);
//# sourceMappingURL=kuaishou.collector.js.map