...
var PublishOptimizerService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.PublishOptimizerService = void 0;
...
let PublishOptimizerService = PublishOptimizerService_1 = class PublishOptimizerService {
    constructor() {
        this.logger = new common_1.Logger(PublishOptimizerService_1.name);
    }
    async getBestPublishTime(dto) {
        const provider = (0, ai_provider_interface_1.getProvider)();
        const platform = dto.platform || 'douyin';
        try {
            const prompt = (0, prompt_templates_1.renderTemplate)('best_publish_time', {
                platform,
    ...
    async getPublishFrequency(dto) {
        ...
        const platform = dto.platform || 'douyin';
        try {
            const prompt = (0, prompt_templates_1.renderTemplate)('publish_frequency', {
                platform,
                contentType: dto.contentType || '短视频',
                audience: dto.audience || '年轻用户',
                historicalData: dto.historicalData || '',
    ...
    analyzeHistoricalBestTime(data) {
        return (0, data_analyzer_1.analyzeBestTimes)(data);
    }
    parseTimeRecommendation(content, platform) {
    ...
    getDefaultRecommendation(platform) {
...
exports.PublishOptimizerService = PublishOptimizerService;
exports.PublishOptimizerService = PublishOptimizerService = PublishOptimizerService_1 = __decorate([
    (0, common_1.Injectable)()
], PublishOptimizerService);
//# sourceMappingURL=publish-optimizer.js.map