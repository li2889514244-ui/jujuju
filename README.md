...
3. `docs/deployment-retrospective-ai-handoff.md`
4. `docs/deployment-remediation-plan.md`
...
- Do not change Pixingyun Mate login, collection, deletion, installer, or update behavior without reading `docs/project-memory.md`.
