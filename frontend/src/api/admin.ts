...
export interface EnterpriseLoginSettings {
  feishu: {
    enabled: boolean
    ...
    mode: string
    defaultOrganizationConfigured?: boolean
  }
}

/** 超管重置用户密码 */
export function resetUserPassword(id: string, password: string) {
  return put<{ success: boolean }>(`/admin/users/${id}/password`, { password })
}
...
/** 企业登录配置诊断 */
export function getEnterpriseLoginSettings() {
  return get<EnterpriseLoginSettings>('/admin/system/enterprise-login')
}
