...
export const accountsApi = {
  ...
  getOperators(id: string) {
    return get<{ operators: AccountOperator[] }>(`/accounts/${id}/operators`)
  },

  updateOperators(
    id: string,
    data: { primaryUserId: string; collaboratorUserIds: string[] },
  ) {
    return put<{ operators: AccountOperator[] }>(`/accounts/${id}/operators`, data)
  },
