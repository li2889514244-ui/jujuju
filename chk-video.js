...
(async()=>{
  ...
  const r1 = await c.request('CreateCommand',{RegionId:'cn-guangzhou',Name:'chkv'+Date.now(),Type:'RunShellScript',CommandContent:s,ContentEncoding:'Base64',Timeout:'60'});
