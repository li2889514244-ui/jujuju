...
(async()=>{
  ...
  const r1 = await c.request('CreateCommand',{RegionId:'cn-guangzhou',Name:'chk3'+Date.now(),Type:'RunShellScript',CommandContent:s,ContentEncoding:'Base64',Timeout:'60'});
